...
class DataAugmentation:
    ...
    def randomColor(image):
        ...
        """
        random_factor = np.random.randint(5, 20) / 10.  # 随机因子
        color_image = ImageEnhance.Color(image).enhance(random_factor)  # 调整图像的饱和度
        random_factor = np.random.randint(5, 15) / 10.  # 随机因子
        brightness_image = ImageEnhance.Brightness(color_image).enhance(random_factor)  # 调整图像的亮度
        random_factor = np.random.randint(5, 20) / 10.  # 随机因1子
...
if __name__ == '__main__':
    times = 2  #重复次数
    imgs_dir = 'C:/Users/13042/Desktop/mypic/train/'
    new_imgs_dir = 'C:/Users/13042/Desktop/mypic/new_train/'
    ...
    funcLists = {"flip", "rotation", "color", "gaussian"}
    # funcLists = {"flip", "rotation", "gaussian"}
